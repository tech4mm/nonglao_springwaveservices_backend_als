...
use App\Filament\Resources\BeingSingleResource\Pages;
use App\Filament\Resources\BeingSingleResource\RelationManagers;
...
class BeingSingleResource extends Resource
{
    protected static ?string $model = BeingSingle::class;

    public static function getNavigationLabel(): string
    {
        return 'Certificate of Being Single'; // Custom text
    }
    ...
    {
        return [
            'index' => Pages\ListBeingSingles::route('/'),
            'create' => Pages\CreateBeingSingle::route('/create'),
            'edit' => Pages\EditBeingSingle::route('/{record}/edit'),
        ];
    }
}
