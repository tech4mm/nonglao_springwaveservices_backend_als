...
use App\Filament\Resources\DependencyRelativeResource\Pages;
use App\Filament\Resources\DependencyRelativeResource\RelationManagers;
...
class DependencyRelativeResource extends Resource
{
    protected static ?string $model = DependencyRelative::class;

    public static function getNavigationLabel(): string
    {
        return 'Certificate of Dependency Relative'; // Custom text
    }
    ...
    {
        return [
            'index' => Pages\ListDependencyRelatives::route('/'),
            'create' => Pages\CreateDependencyRelative::route('/create'),
            'edit' => Pages\EditDependencyRelative::route('/{record}/edit'),
        ];
    }
}
