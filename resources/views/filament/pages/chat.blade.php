...
<div x-data="{ open: false }" @keydown.window.escape="open = false" >
     ...
     <div class="fixed inset-0 z-40 flex md:hidden lg:hidden" x-show="open" x-transition>
            ...
            <!-- Sidebar Content -->
            <div class="relative flex flex-col w-64 bg-white">
                ...
                <div class="p-4 overflow-y-auto">
                    <input type="text" wire:model.debounce.300ms="search"
                        ...
                        class="w-full px-3 py-2 mb-4 border rounded-md text-sm focus:outline-none focus:ring focus:border-blue-300" />
                    <div class="overflow-y-auto h-[calc(100vh-200px)]">
                        @foreach ($this->users as $user)
                            <div wire:click="$set('receiverId', {{ $user->id }})"
                                class="cursor-pointer px-4 py-3 hover:bg-gray-100 flex items-center gap-3 {{ $receiverId === $user->id ? 'bg-gray-200 font-semibold' : '' }}">
    ...
    <div class="bg-white shadow ">
        <!-- Mobile Top Bar -->
        <div class="flex items-center justify-between px-4 py-3 border-b bg-white shadow md:hidden lg:hidden">
                    <button @click="open = true" class="text-gray-500 hover:text-gray-700">
                        ☰
                    </button>
                    <h1 class="text-lg font-semibold">Chat</h1>
                    <div></div>
        </div>
        <div class="flex w-full h-[10vh] bg-white shadow">
            <div class="flex h-screen w-full overflow-y-auto">

                <!-- User List Section -->
                <div class="hidden md:flex lg:flex flex flex-col w-40 bg-white border-r overflow-y-auto">
                    <div class="flex flex-col items-center bg-indigo-100 border border-gray-200 mt-4 py-6 px-4 rounded-lg">
                        <div>
                ...
                <!-- Chat Section -->
                <div class="flex-1 bg-gray-100 p-6 overflow-y-auto h-[10vh] border border-gray-300 border-r">
                    <!-- Messages Container -->
                                            ...
                                            @if ($fileLink)
                                                ...
                                                @endif
                                                    <a href="{{ route('download.file', ['url' => $message->message]) }}" 
                                                        class="flex items-center justify-center p-2 bg-gray-100 rounded hover:bg-gray-200"
                                                        title="Download">
                                                            <svg width="16" height="16" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="fill-current text-gray-700">
                ...
                <div class="flex-grow ml-4">
                    <div class="relative w-full">
                        <input type="text" 
                            ...
                            class="flex w-full px-4 py-2 border rounded-full focus:outline-none focus:ring focus:border-blue-300">
                    </div>
                </div>
                <div class="ml-4">
